...
## Repository Stats
- GitHub repo: Haithm-Shamsan/csharp-myfirstrealproject
- Scan date: 2026-03-26
- Total tracked files scanned: 16
- Text files fully read: 16
- Binary or non-text files: 0
- Approximate text line count: 995
...
- Form2.cs
- Form2.resx
- MyFirstRealProject.csproj
- MyFirstRealProject.sln
- Program.cs
